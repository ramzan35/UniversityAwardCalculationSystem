...
public class Retake1Controller extends MainController implements Initializable {
            ...
            if (flag11 == true) {
                for (int i = 0; i < 6; i++) {
                    if (MainController.moduleMarks1[i] < 40 || MainController.level4ict1[i] < 30 || MainController.level4ict2[i] < 30) {
                        MainController.moduleMarks1[i] = 40;
                        MainController.level4ict1[i] = 30;
                        MainController.level4ict2[i] = 30;
                        flag1 = true;
                        flag22 = false;
                        flag33 = false;
                    }
            ...
            if (flag22 == true) {
                for (int i = 0; i < 6; i++) {
                    if (Main2Controller.mMarks2[i] < 40 || Main2Controller.level5ict1[i] < 30 || Main2Controller.level5ict2[i] < 30) {
                        Main2Controller.mMarks2[i] = 40;
                        Main2Controller.level5ict1[i] = 30;
                        Main2Controller.level5ict2[i] = 30;
                        flag2 = true;
                        flag33 = false;
                    }
                }
            ...
            if (flag33 == true) {
                for (int i = 0; i < 6; i++) {
                    if (Main4Controller.mMarks3[i] < 40 || Main4Controller.level6ict1[i] < 30 || Main4Controller.level6ict2[i] < 30) {
                        Main4Controller.mMarks3[i] = 40;
                        Main4Controller.level6ict1[i] = 30;
                        Main4Controller.level6ict2[i] = 30;
                        flag3 = true;
                    }
                }
            }
